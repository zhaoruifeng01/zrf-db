...
/**
 * Conversations route - migrated from web/pages/conversations/index.tsx.
 *
 * Strangler boundary: legacy Next.js page deleted, route now served by the
 * shell. Reuses web/client/api, web/types/chat, web/utils/date via the `@/`
 * alias until those modules migrate into @dbgpt/shared.
 */
